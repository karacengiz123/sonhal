!function (e, t) {
    ...
    return function (e) {
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), Object.defineProperty(t, "ajax", {
            enumerable: !0,
            get: function () {
                return n.default
            }
        ...
        var n = p(r(5)), i = p(r(6)), a = p(r(7)), s = p(r(8)), o = p(r(1)), u = p(r(9)), l = p(r(10)), c = p(r(2)),
            h = p(r(11)), f = p(r(12)), d = p(r(13));
        ...
        var h = "playing", f = "paused", d = "finished", p = function (e) {
            function t(e) {
                var r, n, i;
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            ...
            return function (e, t) {
                ...
                key: "getPeaks", value: function (e, t, r) {
                    ...
                    for (i = 0; i < o; i++) {
                        ...
                        for (c = t; c <= r; c++) {
                            var h = ~~(c * a), f = ~~(h + a), d = 0, p = 0, v = void 0;
                            for (v = h; v < f; v += s) {
                                var y = l[v];
                                y > p && (p = y), y < d && (d = y)
                            }
        ...
        var n = function (e) {
            ...
            return t.default = e, t
        }(r(0)), i = u(r(14)), a = u(r(3)), s = u(r(16)), o = u(r(17));
        ...
        var m = function (e) {
            ...
            return function (e, t) {
                ...
                key: "setBackgroundColor", value: function (e) {
                    this.params.backgroundColor = e, n.style(this.container, {background: this.params.backgroundColor})
                }
            }, {
                ...
                key: "getArrayBuffer", value: function (e, t) {
                    var r = this, i = n.ajax({url: e, responseType: "arraybuffer", xhr: this.params.xhr});
                ...
                key: "exportPCM", value: function (e, t, r, n) {
                    e = e || 1024, n = n || 0, t = t || 1e4, r = r || !1;
                    var i = this.backend.getPeaks(e, n), a = [].map.call(i, function (e) {
                        return Math.round(e * t) / t
                    }), s = JSON.stringify(a);
                    return r || window.open("data:application/json;charset=utf-8," + encodeURIComponent(s)), s
                }
            }, {
                key: "exportImage", value: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e) {
            var t = new i.default, r = new XMLHttpRequest, n = !1;
        ...
        var n, i = (n = r(1)) && n.__esModule ? n : {default: n};
        e.exports = t.default
    }, function (e, t, r) {
        "use strict";
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0;
        var n, i = (n = r(15)) && n.__esModule ? n : {default: n}, a = function (e) {
            if (e && e.__esModule) return e;
            var t = {};
            if (null != e) for (var r in e) if (Object.prototype.hasOwnProperty.call(e, r)) {
                var n = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(e, r) : {};
        ...
        var h = function (e) {
            ...
            return function (e, t) {
                ...
                key: "addCanvas", value: function () {
                    var e = {}, t = this.maxCanvasElementWidth * this.canvases.length;
                ...
                key: "updateDimensions", value: function (e, t, r) {
                    var n = Math.round(t / this.params.pixelRatio), i = Math.round(this.width / this.params.pixelRatio);
                    e.start = e.waveCtx.canvas.offsetLeft / i || 0, e.end = e.start + n / i, e.waveCtx.canvas.width = t, e.waveCtx.canvas.height = r, this.style(e.waveCtx.canvas, {width: n + "px"}), this.style(this.progressWave, {display: "block"}), this.hasProgressCanvas && (e.progressCtx.canvas.width = t, e.progressCtx.canvas.height = r, this.style(e.progressCtx.canvas, {width: n + "px"}))
                }
            }, {
                ...
                key: "clearWaveForEntry", value: function (e) {
                ...
                key: "drawBars", value: function (e, t, r, n) {
                    ...
                    return this.prepareDraw(e, t, r, n, function (e) {
                        ...
                        if (void 0 !== r) {
                            var l, c = a ? 2 : 1, h = u.length / c, f = i.params.barWidth * i.params.pixelRatio,
                                ...
                                p = h / i.width, v = n;
                            for (l = r; l < v; l += d) {
                                var y = u[Math.floor(l * p * c)] || 0, m = Math.round(y / t * o);
                ...
                key: "drawLine", value: function (e, t, r, n, i, a) {
                    var s = this;
                ...
                key: "drawLineToContext", value: function (e, t, r, n, i, a, s, o) {
                    if (t) {
                        var u, l, c = r.length / 2, h = Math.round(c * e.start), f = h, d = Math.round(c * e.end) + 1,
                            p = e.progress.width / (d - f - 1), v = i + a, y = n / i;
                        for (t.beginPath(), t.moveTo((f - h) * p, v), t.lineTo((f - h) * p, v - Math.round((r[2 * f] || 0) / y)), u = f; u < d; u++) {
                            var m = r[2 * u] || 0, b = Math.round(m / y);
                            t.lineTo((u - h) * p + this.halfPixel, v - b)
                        }
                        for (l = d - 1; l >= f; l--) {
                            var g = r[2 * l + 1] || 0, k = Math.round(g / y);
                ...
                key: "prepareDraw", value: function (e, t, r, n, i) {
                    var s = this;
                    return a.frame(function () {
                        ...
                        if (s.params.normalize) {
                            var l = a.max(e), c = a.min(e);
                            u = -c > l ? -c : l
                        }
                        var h = [].some.call(e, function (e) {
                            return e < 0
                        }), f = s.params.height * s.params.pixelRatio;
                        return i({absmax: u, hasMinVals: h, height: f, offsetY: f * t || 0, halfH: f / 2, peaks: e})
                    })()
                }
            }, {
                key: "fillRectToContext", value: function (e, t, r, n, i) {
                ...
                key: "getImage", value: function (e, t) {
            ...
            return function (e, t) {
                ...
                key: "handleEvent", value: function (e, t) {
                    ...
                    var r, n = e.targetTouches ? e.targetTouches[0].clientX : e.clientX,
                        i = this.wrapper.getBoundingClientRect(), a = this.width, s = this.getWidth();
        ...
        var h = function (e) {
            ...
            return function (e, t) {
                ...
                key: "getPeaks", value: function (e, r, n) {
