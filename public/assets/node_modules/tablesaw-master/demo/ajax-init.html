...
<head>
	...
	$( document ).ready(function() {
		...
		$( '#ajaxed' ).html( "<table class='tablesaw' data-tablesaw-mode='swipe' id='example23'><thead><tr><th scope='col' data-tablesaw-priority='persist'>Name</th><th scope='col'>P1</th><th scope='col'>P2</th><th scope='col'>P3</th><th scope='col'>P4</th><th scope='col'>P5</th><th scope='col'>P6</th></tr></thead><tbody id='place1'></tbody></table>" );
