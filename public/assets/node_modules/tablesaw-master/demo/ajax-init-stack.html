...
<head>
	...
	$( document ).ready(function() {
		...
		$( '#ajaxed' ).html( "<table class='tablesaw tablesaw-stack' data-tablesaw-mode='stack' id='example23'><thead><tr><th scope='col' data-tablesaw-priority='persist'>Name</th><th scope='col'>P1</th><th scope='col'>P2</th><th scope='col'>P3</th><th scope='col'>P4</th><th scope='col'>P5</th><th scope='col'>P6</th></tr></thead><tbody id='place1'></tbody></table>" );

		var tbody = $( '#example23 tbody' ), props = ["Name","P1","P2","P3","P4","P5","P6"];
		...
		$('#example23').tablesaw().data( "tablesaw" ).refresh();
