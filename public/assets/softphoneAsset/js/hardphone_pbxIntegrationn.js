...
//     $.ajax({
//         type: 'GET',
//         url: '/api/hardphone/getLastCalls/' + hardPhoneExtension,
//         headers: {
...
//
//             $.each(obj, function () {
//                 // text +=  '<option href="javascript:IVRTransfer(\'80'+this['idx']+'\');">'+this['description']+'</option>'
//
//
...
//     $.ajax({
//         type: 'GET',
//         url: '/api/hardphone/last-register-add-update-remove/' + hardPhoneExtension,
//         headers: {
//             'Authorization': "Bearer " + getTokenStorage(),
//             'accept': "application/json",
//             'Content-Type': "application/json",
