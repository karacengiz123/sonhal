...
//     if(tbxDebug==true) console.log($phoneNumber);
//     if(tbxDebug==true) console.log(callID);
//     if ($phoneNumber) {
//         if (callID){
//             $.ajax({
//                 type: 'GET',
...
//             });
//         } else {
//             $("#breakText").html("Aktif Çağrı Bulunmamaktadır..");
...
//     if(tbxDebug==true) document.getElementById("siebelFrame").contentWindow.postMessage('{ "action": "agentLogin", "payload": { "username": "CAGRIAGENT8", "password": "CAGRIAGENT8", "token": "' + window.localStorage.getItem("token") + '" }}','*');
//     var pass = password;
...
//     $.ajax({
//         type: 'GET',
//         url: '/api/hardphone/agent-managament-control/'+hardPhoneExtension,
//         headers: {
//             'Authorization': "Bearer " + getTokenStorage(),
//             'accept': "application/json",
//             'Content-Type': "application/json",
...
//                     $.ajax({
//                         type: 'GET',
//                         url: '/api/hardphone/pause-control/'+hardPhoneExtension,
//                         headers: {
//                             'Authorization': "Bearer " + getTokenStorage(),
//                             'accept': "application/json",
//                             'Content-Type': "application/json",
