...
$(document).ready(function () {
    tbxPro = {
        config: {
            ...
            wsServers: 'wss://10.7.157.67:8089/ws',
            // wsServers: 'wss://10.7.154.191:8089/ws',
            //wsServers: 'wss://10.5.254.176:8089/ws', //agent.WSServer,
            //wsServers: 'wss://10.4.130.115:8089/ws', //agent.WSServer,
            registerExpires: 30,
            iceCheckingTimeout: 500,
            traceSip: true,
            //  turnServers: [{urls : 'turn:stun.sipsandbox.xyz:53', username: 'tbxPro', password: 'Q1w2e3r4'}],
            //  stunServers: ['stun:stun.sipsandbox.xyz:53'],
        ...
        newSession: function (newSess) {
            ...
            if (newSess.direction == 'incoming') {
                ...
                if (newSess.callDirection != "Local") {
                    // if ([2,6,8,12,13,14,15,16,17,18,19,20].indexOf(parseInt(softVue.agentStatus)) > -1){
                    //     newSess.reject();
                    //     return false;
                    // }
            ...
            if (newSess.direction == 'incoming') {
                ...
                if (newSess.callDirection != "Local") {
                    setTimeOutCallAccept = setTimeout(function () {
                        newSess.accept({
                            media: {
            ...
            newSess.on('accepted', function (e) {
                ...
                $("#arayanNoCopy").val(newSess.displayName);
                clickCopyNumber(newSess.displayName);
                ...
                if (newSess == null) {
                    ...
                    if (newSess.callDirection == 'Local') {
                        ...
                        if (newSess.direction == "outgoing"){
                            toBeSentData.body.Description = "Giden Çağrı Araması: (+9"+newSess.displayName+")";
                            toBeSentData.body.Type = "Çağrı - Giden";
                            toBeSentData.body.ActivitySubtype = "Çağrı - Giden";
                        }

                        if (softVue.siebelFeedBackCallData != null){
                            var endDate = moment(new Date()).format('M/D/Y H:mm:ss');
                        ...
                        createActivity(toBeSentData , newSess);
            ...
            newSess.on('rejected', function (e) {
                ...
                else if(newSess.callDirection == 'incoming')
                {
                    console.log('TbxCheck');
                }
                else {
                    if (newSess.callDirection == 'Local') {
                        softVue.agentStatus = 1007;
        ...
        getUserMediaFailure: function (e) {
            softVue.agentStatus = 20;
            window.console.log('getUserMedia failed:', e);
        },
        ...
        phoneCallButtonPressed: function () {
            clearTimeout(setTimeOutCallAccept);
