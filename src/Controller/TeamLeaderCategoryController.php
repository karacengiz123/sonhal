...
class TeamLeaderCategoryController extends AbstractController
{

    /**
     * @IsGranted("ROLE_TEAMLEADERQUESTION")
     * @Route("/team-leader-category",name="team_leader_category")
    ...
    public function teamLeaderCategory(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->render("team_leader_category/selectCategory.html.twig", [
